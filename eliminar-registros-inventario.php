...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      ...
                      <span aria-hidden="true">Deseas Eliminar el Registro</span>
                      </button>
           ...
           <center>
            <form method="post"  action="sql/eliminar-registro.php?id=<?php echo $id;?>">
            <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['ancla'];?>" required ><br>
            <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['accesorio'];?>" required ><br>
            <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['color'];?>" required >
   </div>   
    </div>
  </div>
