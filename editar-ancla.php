...
<head>
  ...
  $query = "SELECT * FROM ancla WHERE id ='$id'";
      ...
      <div class="modal-content">
        <div class="modal-header btn btn-dark">
          <h5 class="modal-title" id="exampleModalLabel"><button type="button" class="btn-close btn btn-danger btn-sm" data-dismiss="modal">
              <span aria-hidden="true">Editar Ancla</span>
            </button>
          </h5>
        </div>
        <div class="modal-body">
          <div class="card border mb-3" style="max-width: 50rem;">
            <div class="card-body text-secondary">
              <center>
                <form method="post" action="sql/modificar-ancla.php">
                  ...
                  Usuario<input class="form-control form-control-sm" type="text" name="edit_nom" id="edit_nom" placeholder="nombre" value="<?php echo $row['nombre'] ?>" required>
