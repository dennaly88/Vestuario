...
$query = "SELECT * FROM lavanderia WHERE id ='$id'";
...
?>
    ...
    <div class="modal fade" id="danny8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           ...
           <center>
            <form method="post"  action="sql/eliminar-lavanderia.php?id=<?php echo $id;?>">
            <input class="form-control form-control-sm" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="<?php echo $row['accesorio'];?>" required >
   </div>   
    </div>
  </div>
