        ...
        <div class="modal-body">
          <div class="card border mb-3" style="max-width: 50rem;">
            <div class="card-body text-secondary">
              <center>
                <form method="post" action="sql/modificar-lavanderia.php">
                  ...
                  Accesorios<input class="form-control form-control-sm" type="text" name="edit_accesorio" readonly id="edit_accesorio" placeholder="Accesorio" value="<?php echo $row['accesorio'] ?>" required>
